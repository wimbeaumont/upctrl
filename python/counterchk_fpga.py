...
def main(argv):
    ...
    pi.write(SEL0, 1) # select clk dev  register
    pi.write(SEL1, 1)
    ...
    pi.write(SEL1, 1)
    # D0 = 1 Coincedence = AND at  input ,  D1,D2 1,1 input sel ext  ,  D3 =1 disable window timing 
    settings=[1,1,0,1,0,0,0,0]
    ...
    pi.write(D2, 0)
    """
    sleep(1) # wait for some counts to accumulate
    # read the counters
    for cnt in range(6):
        set_muxout2(cnt, 8)
    ...
    pi.write(D2, 0) # disable counting
